...
def v_timestamp():
    ...
    return render_template('display_complaint.html', data=account)
...
def agentassign():
  if request.method == 'POST':
    ...
    return render_template('display_complaint.html', msg="Data saved successfuly..Please login using your details")
